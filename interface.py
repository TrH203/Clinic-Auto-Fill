...
class AutomationGUI:
    ...
    def _get_github_token(self):
        """Reads the GitHub token from a local file."""
        try:
            with open("github_token.txt", "r") as f:
                return f.read().strip()
        except FileNotFoundError:
            self.log_message("✗ `github_token.txt` not found. Update check skipped.", "ERROR")
            self.log_message("  Please create this file and paste your GitHub Personal Access Token into it.", "INFO")
            return None
